                ...
                <div class="p-6 text-gray-900 grid md:grid-cols-3 gap-4 grid-cols-1">
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI UMUM</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI TUGAS AKHIR</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI KKN</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI KKI</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI HIBAH</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
                    ...
                    <div class="bg-white px-8 py-4 w-full rounded-3xl shadow-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="mt-3">
                                    <h1 class="font-extrabold">JUMLAH KOLEKSI BELI</h1>
                                </div>
                                <p class="text-sm">Hingga Tanggal <span
                                        class="font-bold">{{ now()->format('d/m/Y') }}</span></p>
                            </div>
