                ...
                <div class="p-4 text-gray-900 w-full">
                    ...
                    <div class="flex justify-center">
                        <div class="p-12" style="width:100%">
                            <table class="table table-bordered" id="bmasuk-datatable">
                                <thead>
                                    <tr>
                                        <th class="w-7">No.</th>
                                        <th>Kode Item</th>
            ...
            const changeFilterDataRegisterProgram = () => {
                ...
                if (dataTableDataRegisterProgramInstance) {
                    ...
                    getDataTableRegisterProgram()
                        .then((response) => {
                            dataTableDataRegisterProgramInstance = $('#bmasuk-datatable').DataTable(
                                response
                                .config);
        ...
        const exportExcel = async () => {
            ...
            try {
                ...
                dataNabil.forEach((data, index) => {
                    ...
                    const day = date.getDate().toString().padStart(2,
                    '0'); // format tanggal dua digit (01-31)
                    const month = (date.getMonth() + 1).toString().padStart(2,
                    '0'); // format bulan dua digit (01-12)
                    const year = date.getFullYear();
