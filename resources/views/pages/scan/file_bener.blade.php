...
<body class="bg-slate-300 mx-auto">
            ...
            <div class="w-full md:w-1/2 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal" enctype="multipart/form-data">
                    ...
                    <div id="pengembalianForm" class="hidden">
                        <input type="hidden" name="idItemKembali" id="idItemKembali">
                    ...
                    <div class="flex items-center p-4 space-x-2 border-t border-gray-200 rounded-b">
                        ...
                        <button type="submit" id="formSourceButtonKembali"
                            class="bg-amber-400 m-2 w-40 h-10 rounded-xl hidden hover:bg-amber-500">Simpan</button>
                        <button type="button" onclick="sourceModalClose()"
    ...
    <script>
        ...
        const pengembalianSourceModal = (id, ItemStatus) => {
            ...
            // Disable peminjamanForm inputs to prevent submission
            const peminjamanInputs = peminjaman.querySelectorAll('input, textarea, select');
            peminjamanInputs.forEach(input => input.disabled = true);

            // Enable pengembalianForm inputs
            const pengembalianInputs = pengembalian.querySelectorAll('input, textarea, select');
            pengembalianInputs.forEach(input => input.disabled = false);
