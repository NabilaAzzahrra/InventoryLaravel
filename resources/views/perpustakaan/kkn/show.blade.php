                            ...
                            <div class="flex justify-center">
                                <div class="p-12" style="width:100%">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-bold">Nama Kelompok</span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-bold">Anggota Kelompok</span>
                                    </div>
                                    <div class="mt-4 ml-8">
                                            ...
                                            @foreach ($detail as $d)
                                                <div>
                                                    ...
                                                    <div class="ml-8 mt-2">
                                                        ...
                                                        <span class="font-bold">{{$d->nim}}</span>
                                                    </div>
                                                    <div class="ml-8 mt-2">
                                                        <i class="fa-solid fa-fire"></i>
                                                        <span class="font-bold">{{$d->jurusan}}</span>
                                                    </div>
                                                    <div class="ml-8 mt-2">
                                                        <i class="fa-solid fa-landmark"></i>
                                                        <span class="font-bold">{{$d->kelas}}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                    ...
                                    <button type="button"
                                        onclick="window.location.href='{{ route('kelompok_kkn.edit', $koleksi->id_koleksi) }}'"
                                    ...
                                    <button type="button"
                                        onclick="window.location.href='{{ route('kelompok_kkn.index') }}'"
