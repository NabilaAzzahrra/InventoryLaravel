...
<body class="antialiased">
    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="flex items-center justify-between gap-5 p-5 mx-10">
                <div class="ml-10">
                    ...
                    <p class="text-md pb-6">Monitoring inventory and item lending with a web-based application at LP3I
                        ...
                        and accurate management. By using this application, users can easily monitor the availability
                        and usage of inventory in real-time. The goal is to enhance productivity and organization within
                        the campus.</p>
                    @auth
                    ...
                    @else
                        <div class="flex gap-5">
                            <a href="{{ route('login') }}"
                                class="bg-sky-400 hover:bg-sky-500 py-2 px-8 rounded-2xl font-bold">Login</a>
                ...
                <div class="-mr-10">
                    <dotlottie-player src="{{ url('json/landing.json') }}" background="transparent" speed="1"
                        style="width: 800px; height: 800px;" loop autoplay></dotlottie-player>
                </div>
            </div>
        @endif
    </div>
